...
// FIXME - clock and team getters should either return null or throw exception instead of creating new clock/team...
    ...
    public static final String RULE_NUMBER_PERIODS = "Rule." + Clock.ID_PERIOD + ".Number";
    public static final String RULE_PERIOD_DURATION = "Rule." + Clock.ID_PERIOD + ".Duration";
    public static final String RULE_PERIOD_DIRECTION = "Rule." + Clock.ID_PERIOD + ".Direction";
    public static final String RULE_PERIOD_END_BETWEEN_JAMS = "Rule." + Clock.ID_PERIOD + ".EndBetweenJams";
    public static final String RULE_JAM_NUMBER_PER_PERIOD = "Rule." + Clock.ID_JAM + ".ResetNumberEachPeriod";
    public static final String RULE_JAM_DURATION = "Rule." + Clock.ID_JAM + ".Duration";
    public static final String RULE_JAM_DIRECTION = "Rule." + Clock.ID_JAM + ".Direction";
    public static final String RULE_LINEUP_DURATION = "Rule." + Clock.ID_LINEUP + ".Duration";
    public static final String RULE_OVERTIME_LINEUP_DURATION = "Rule." + Clock.ID_LINEUP + ".OvertimeDuration";
    public static final String RULE_LINEUP_DIRECTION = "Rule." + Clock.ID_LINEUP + ".Direction";
    public static final String RULE_TTO_DURATION = "Rule." + Clock.ID_TIMEOUT + ".TeamTODuration";
    public static final String RULE_TIMEOUT_DIRECTION = "Rule." + Clock.ID_TIMEOUT + ".Direction";
    public static final String RULE_STOP_PC_ON_TO = "Rule." + Clock.ID_TIMEOUT + ".StopPeriodClockAlways";
    public static final String RULE_STOP_PC_ON_OTO = "Rule." + Clock.ID_TIMEOUT + ".StopPeriodClockOnOTO";
    public static final String RULE_STOP_PC_ON_TTO = "Rule." + Clock.ID_TIMEOUT + ".StopPeriodClockOnTTO";
    public static final String RULE_STOP_PC_ON_OR = "Rule." + Clock.ID_TIMEOUT + ".StopPeriodClockOnOR";
    public static final String RULE_STOP_PC_AFTER_TO_DURATION = "Rule." + Clock.ID_TIMEOUT + ".StopPeriodClockAfterTODuration";
    public static final String RULE_INTERMISSION_DURATIONS = "Rule." + Clock.ID_INTERMISSION + ".Durations";
    public static final String RULE_INTERMISSION_DIRECTION = "Rule." + Clock.ID_INTERMISSION + ".Direction";
    public static final String RULE_AUTO_START = "Rule.ClockControl.AutoStart";
    public static final String RULE_AUTO_START_JAM = "Rule.ClockControl.AutoStartType";
    public static final String RULE_AUTO_START_BUFFER = "Rule.ClockControl.AutoStartBuffer";
    public static final String RULE_AUTO_END_JAM = "Rule.ClockControl.AutoEndJam";
    public static final String RULE_AUTO_END_TTO = "Rule.ClockControl.AutoEndTTO";
