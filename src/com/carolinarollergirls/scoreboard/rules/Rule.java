...
public enum Rule {
    ...
    EXTRA_JAM_AFTER_OTO(new BooleanRule("Timeout.ExtraJamAfterOTO", "Can an OTO cause an extra Jam to be played when there wouldn't be one otherwise?", false, "True", "False")),
    ...
    AUTO_START_JAM(
            new BooleanRule("Automate.AutoStartType", "What to start after lineup is up", false, "Jam", "Timeout")),
