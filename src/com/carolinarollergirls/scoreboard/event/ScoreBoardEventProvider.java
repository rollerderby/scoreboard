...
public interface ScoreBoardEventProvider extends ValueWithId, Comparable<ScoreBoardEventProvider> {
    ...
    public <T> boolean set(PermanentProperty<T> prop, T value);
    /*
    ...
    // return value indicates if value was changed
    public <T> boolean set(PermanentProperty<T> prop, T value, Source source);
    /*
     * return value indicates if value was changed Change flag for Integer and Long
     * values is implemented to add the given value to the previous one. Other flags
     * need to be implemented in overrides.
    ...
    public <T extends ValueWithId> void removeAll(AddRemoveProperty<T> prop);
    ...
    public static final PermanentProperty<String> ID = new PermanentProperty<>(String.class, "Id", "");
    public static final PermanentProperty<Boolean> READONLY = new PermanentProperty<>(Boolean.class, "Readonly", false);
