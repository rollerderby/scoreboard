...
public abstract class OrderedScoreBoardEventProviderImpl<T extends OrderedScoreBoardEventProvider<T>>
    ...
    public OrderedScoreBoardEventProviderImpl(ScoreBoardEventProvider parent, String id, AddRemoveProperty type,
            Class<T> ownClass, Class<? extends Property>... props) {
        super(parent, id, type, ownClass, props);
        providerClass = ownClass;
    ...
    @Override
    public Class<T> getProviderClass() { return providerClass; }
