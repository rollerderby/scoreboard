...
public final class SettingsImpl extends ScoreBoardEventProviderImpl<Settings> implements Settings {
    ...
    private void setDefaults() {
        ...
        set("ScoreBoard.Operator_Default.AutoStart", "");
        set("ScoreBoard.Operator_Default.AutoStart5", "");
        set("ScoreBoard.Operator_Default.Auto5", "false");
        ...
        set(ScoreBoard.SETTING_AUTO_START_5, "");
        set(ScoreBoard.SETTING_AUTO_5, "false");
        set(ScoreBoard.SETTING_EARLY_5_DELAY, "1");
