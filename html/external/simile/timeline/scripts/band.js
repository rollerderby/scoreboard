...
Timeline._Band = function(timeline, bandInfo, index) {
    ...
    this._bgColor = bandInfo.bgColor;
...
Timeline._Band.prototype.addOnWidthListener = function(listener) {
    this._onWidthListeners.push(listener);
};

Timeline._Band.prototype.removeOnWidthListener = function(listener) {
    for (var i = 0; i < this._onWidthListeners.length; i++) {
        if (this._onWidthListeners[i] == listener) {
            this._onWidthListeners.splice(i, 1);
            break;
        }
    }
};
...
Timeline._Band.prototype._fireOnWidth = function() {
    for (var i = 0; i < this._onWidthListeners.length; i++) {
        this._onWidthListeners[i](this);
    }
};
